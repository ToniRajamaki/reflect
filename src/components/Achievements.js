...
function Achievements() {
  return (
    ...
    <div
      ...
      <div
        class="flex flex-col justify-center items-center p-8 border border-secondary border-opacity-30  rounded-3xl bg-secondary bg-opacity-10   shadow-gray-600/10 px-4 h-[126px] w-[100%] md:w-[281px] md:h-[192px] rounded-lg justify-self-center">
        <div class="flex flex-row justify-center items-center">
          <svg class="w-[35px] h-[35px] md:w-[50px] md:h-[50px]" viewBox="0 0 50 50" fill="none"
            ...
            <path
              ...
              stroke="#44d1fd" stroke-width="3.473" stroke-linecap="round" stroke-linejoin="round"></path>
            <path
          ...
          <p class="font-semibold text-3xl sm:text-4xl lg:text-5xl leading-9 text-secondary text-opacity-80 ml-2">75K+</p>
        </div>
        <p class="mt-4 text-base leading-7  sm:mt-8  text-base sm:text-lg leading-6 mt-3 md:mt-6 text-center">Expert Chat &amp; Call Minutes</p>
      </div>
      <div
        class="flex flex-col justify-center items-center p-8 border border-secondary border-opacity-30  rounded-3xl bg-secondary bg-opacity-10   shadow-gray-600/10 px-4 h-[126px] w-[100%] md:w-[281px] md:h-[192px] rounded-lg justify-self-center">
        <div class="flex flex-row justify-center items-center">
          <svg class="w-[35px] h-[35px] md:w-[50px] md:h-[50px]" viewBox="0 0 51 50" fill="none"
            ...
            <g clip-path="url(#a)">
              <path
                ...
                stroke="#44d1fd" stroke-width="4.341" stroke-linecap="round" stroke-linejoin="round"></path>
            </g>
            <defs>
              <clipPath id="a">
          ...
          <p class="font-semibold text-3xl sm:text-4xl lg:text-5xl leading-9 text-secondary text-opacity-80 ml-2">4.9</p>
        </div>
        <p class="mt-4 text-base leading-7  sm:mt-8  text-base sm:text-lg leading-6 mt-3 md:mt-6 text-center">Average Expert Rating</p>
      </div>
      <div
        class="flex flex-col justify-center items-center p-8 border border-secondary border-opacity-30  rounded-3xl bg-secondary bg-opacity-10   shadow-gray-600/10 px-4 h-[126px] w-[100%] md:w-[281px] md:h-[192px] rounded-lg justify-self-center">
        <div class="flex flex-row justify-center items-center">
          <svg class="w-[35px] h-[35px] md:w-[50px] md:h-[50px]" viewBox="0 0 50 50" fill="none"
            xmlns="http://www.w3.org/2000/svg">
            <g clip-path="url(#a)" stroke="#44d1fd" stroke-width="3.473" stroke-linecap="round" stroke-linejoin="round">
              <path
          ...
          <p class="font-semibold text-3xl sm:text-4xl lg:text-5xl leading-9 text-secondary text-opacity-80 ml-2">8900+</p>
        </div>
        <p class="mt-4 text-base leading-7  sm:mt-8  text-base sm:text-lg leading-6 mt-3 md:mt-6 text-center">Sessions Completed</p>
      </div>
      <div
        class="flex flex-col justify-center items-center p-8 border border-secondary border-opacity-30  rounded-3xl bg-secondary bg-opacity-10   shadow-gray-600/10 px-4 h-[126px] w-[100%] md:w-[281px] md:h-[192px] rounded-lg justify-self-center">
        <div class="flex flex-row justify-center items-center">
          <svg class="w-[35px] h-[35px] md:w-[50px] md:h-[50px]" viewBox="0 0 51 50" fill="none"
            xmlns="http://www.w3.org/2000/svg">
            <path d="M45.571 12.006 27.046 30.531l-7.719-7.718L5.434 36.706" stroke="#44d1fd" stroke-width="4.341"
              stroke-linecap="round" stroke-linejoin="round"></path>
            <path d="M45.569 24.356v-12.35h-12.35" stroke="#44d1fd" stroke-width="4.341" stroke-linecap="round"
              stroke-linejoin="round"></path>
          </svg>
          <p class="font-semibold text-3xl sm:text-4xl lg:text-5xl leading-9 text-secondary text-opacity-80 ml-2">1.5M+</p>
        </div>
        <p class="mt-4 text-base leading-7  sm:mt-8  text-base sm:text-lg leading-6 mt-3 md:mt-6 text-center">App Downloads</p>
      </div>
    </div>
  </section>
  )
