  ...
  return (
    <div className='px-4 py-1 mx-auto text-center sm:px-6 lg:py-24 lg:px-8 bg-indigo-100 bg-opacity-50 '>
      <p className='text-3xl font-bold leading-normal  text-white-900  sm:text-4xl'>
        <span data-aos="fade-left" className='bg-clip-text dark:text-gray-900'>Ready to try?</span>
        <br />
        <span data-aos="fade-left" data-aos-delay="750" className='bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent'>
          Read the Game-changer.
        </span>
      </p>
      <div data-aos="zoom-in" data-aos-delay="800"  className='flex justify-center gap-4 mt-8 font-medium'>
      <a
        href="#"
